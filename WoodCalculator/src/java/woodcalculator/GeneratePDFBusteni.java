 ...
 * @author Sabau Ionut
 */
public class GeneratePDFBusteni {
    ...
    public void generate(File path, String fileName, String user, String data) throws FileNotFoundException, DocumentException, BadElementException, IOException{
       ...
       try{
            ...
            String url = "C:/Users/Sabau Ionut/OneDrive/Desktop/Proiect/WoodCalculator/WoodCalculatorLogin/imagini/bustean115.png";
            ...
            c1 = new PdfPCell(new Phrase("Lungime"));
            table.addCell(c1);
            
            c1 = new PdfPCell(new Phrase("Diametru"));
            table.addCell(c1);
            ...
            try{
                ...
                while(rs.next()){
                    ...
                    table.addCell(nrBuc);
                    table.addCell(lungime);
                    table.addCell(diametru);
                    table.addCell(volum);
